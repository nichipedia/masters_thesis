...
The decision function could be something similar to the geospatial cache utilized in the Model Injector, or a decision based off selected features, or even a yet unknown factor.
In theory, optimizing the predictor for a region will include \ac{ML} models and physics models.
