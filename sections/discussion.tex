...
\par
The evidence supports the theory that an \ac{ML} model can be chosen based on geospatial location.
...
The Grid Optimized Model Injector shows that a simple geospatial decision function can be used to improve theoretical prediction accuracy.
