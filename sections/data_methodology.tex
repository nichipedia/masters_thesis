...
All other features and their origin datasets can be seen in the table \ref{table:FEATURE_LIST}. %Insert point to figure yadaydada
...
The binary characters represent wether a feature is active or inactive.
...
Global data is tpically represented in a grid formated where each grid represents a coverage of the Earth's surface.
