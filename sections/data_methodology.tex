...
Recall is a measurement of how good a model is at avoiding false negatives.
...
Conversion proved to be trivial because of the ordered nature of bathymetry.
...
Essentially, this gives a true positive an error of approximately 150 meters.
...
The following models were imported from Sklearns library and trained: Random Forest Classifier, Quadratic Discriminant Classifier, AdaBoost Classifier, Gradient Boosting Clasifier, Decision Tree Classifier, Artificial Neural Network Classifier, Voting Classifier, KNN Classifier, Bagging Classifier, NaiveBayes Classifier.
...
For example, consider a model this is excellent at predicting shallow bathymetry.
This models performance could be explained by how it interprets data and models it.
...
Dynamically injecting selected models allows for the best predictor be used across the globe.
In reality, this methodology resulted in a higher accuracy, and can be extended to other selection functions.
