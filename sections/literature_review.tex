...
They are susceptible to overfitting and can create overly complex trees that do not generalize well.
Overfitting is where a model will fit too closely to a training set \cite{cawley2010over}, making it unable to make accurate predictions on data outside of the training data.
...
This also helps to control overfitting because each tree is fit to a sub-sample of the dataset.
...
These types of boosting algorithms tend to overfeed the model.
