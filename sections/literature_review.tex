...
Training a model without "truth" is used for grouping similar values together programmatically.
...
\begin{figure}[htp]
    ...
    \caption{The above figure is an example of a decision tree.
...
\begin{figure}[htp]
    ...
    \caption{The above figure is an example of the KNN algorithm for classification.
...
\begin{figure}[htp]:
    ...
    \caption{Figure showing A Multi-Layer Perceptron.
...
If you knew the probability of both falling you could use Bayes theorem to calculate the probability of both happening together.
...
\begin{figure}[htp]
    ...
    \caption{The above figure shows 3 lines fit to a set of points.
